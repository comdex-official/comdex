...
comdex keys add cooluser --keyring-backend test
comdex add-genesis-account $(comdex keys show cooluser --keyring-backend test -a) 1000000000000000000000stake,100000000000000000000000ucmdx,100000000000000000ucgold,100000000000000000ucsilver,100000000000000000ucoil
