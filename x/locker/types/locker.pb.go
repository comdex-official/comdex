...
type Locker struct {
	...
	ReturnsAccumulated cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=returns_accumulated,json=returnsAccumulated,proto3,customtype=cosmossdk.io/math.Int" json:"returns_accumulated" yaml:"returns_accumulated"`
	NetBalance         cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=net_balance,json=netBalance,proto3,customtype=cosmossdk.io/math.Int" json:"net_balance" yaml:"net_balance"`
...
type UserTxData struct {
	...
	Balance cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=balance,proto3,customtype=cosmossdk.io/math.Int" json:"balance" yaml:"balance"`
...
type LockerLookupTableData struct {
	...
	DepositedAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=deposited_amount,json=depositedAmount,proto3,customtype=cosmossdk.io/math.Int" json:"deposited_amount" yaml:"deposited_amount"`
}
...
type LockedDepositedAmountDataMap struct {
	...
	DepositedAmount cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=deposited_amount,json=depositedAmount,proto3,customtype=cosmossdk.io/math.Int" json:"deposited_amount" yaml:"deposited_amount"`
}
...
type LockerTotalRewardsByAssetAppWise struct {
	AppId        uint64                `protobuf:"varint,1,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty" yaml:"app_id"`
	AssetId      uint64                `protobuf:"varint,2,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty" yaml:"asset_id"`
	TotalRewards cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=total_rewards,json=totalRewards,proto3,customtype=cosmossdk.io/math.Int" json:"total_rewards" yaml:"total_rewards"`
}
...
var fileDescriptor_5cf8d15809df39ec = []byte{
	...
	,
}
