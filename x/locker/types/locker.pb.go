...
type UserLockerAssetMapping struct {
	...
	LockerAppMapping []LockerToAppMapping `protobuf:"bytes,2,rep,name=locker_app_mapping,json=lockerAppMapping,proto3" json:"locker_app_mapping" yaml:"locker_app_mapping"`
}
...
type LockerToAppMapping struct {
	...
	UserAssetLocker []AssetToLockerMapping `protobuf:"bytes,2,rep,name=user_asset_locker,json=userAssetLocker,proto3" json:"user_asset_locker" yaml:"user_asset_locker"`
}
...
type AssetToLockerMapping struct {
	...
	UserTxData []UserTxData `protobuf:"bytes,3,rep,name=userTxData,proto3" json:"userTxData" yaml:"userTxData"`
}
...
type UserTxData struct {
	TxType  string                                 `protobuf:"bytes,1,opt,name=txType,proto3" json:"txType,omitempty" yaml:"txType"`
...
var fileDescriptor_5cf8d15809df39ec = []byte{
	...
	,
}
