...
var (
	...
	ErrorCollectorLookupDoesNotExists           = errors.Register(ModuleName, 914, "Collector lookup does not exists")
	ErrorAppMappingIDMismatch                   = errors.Register(ModuleName, 915, "App Mapping Id mismatch")
	ErrorUnknownMsgType                         = errors.Register(ModuleName, 916, "unknown message type")
)
