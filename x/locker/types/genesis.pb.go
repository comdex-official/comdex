...
// source: petri/locker/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "petri.locker.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("petri/locker/v1beta1/genesis.proto", fileDescriptor_4bd3c61b4d1357a2)
}
