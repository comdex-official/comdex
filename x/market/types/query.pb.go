...
// source: petri/market/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryMarketsRequest)(nil), "petri.market.v1beta1.QueryMarketsRequest")
	proto.RegisterType((*QueryMarketsResponse)(nil), "petri.market.v1beta1.QueryMarketsResponse")
	proto.RegisterType((*QueryMarketRequest)(nil), "petri.market.v1beta1.QueryMarketRequest")
	proto.RegisterType((*QueryMarketResponse)(nil), "petri.market.v1beta1.QueryMarketResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "petri.market.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "petri.market.v1beta1.QueryParamsResponse")
}

func init() { proto.RegisterFile("petri/market/v1beta1/query.proto", fileDescriptor_53ea557cbafb5845) }
...
func (c *queryClient) QueryMarkets(ctx context.Context, in *QueryMarketsRequest, opts ...grpc.CallOption) (*QueryMarketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.market.v1beta1.Query/QueryMarkets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryMarket(ctx context.Context, in *QueryMarketRequest, opts ...grpc.CallOption) (*QueryMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.market.v1beta1.Query/QueryMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryParams(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.market.v1beta1.Query/QueryParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryMarkets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.market.v1beta1.Query/QueryMarkets",
	}
...
func _Query_QueryMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.market.v1beta1.Query/QueryMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.market.v1beta1.Query/QueryParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.market.v1beta1.Query",
	...
	Metadata: "petri/market/v1beta1/query.proto",
}
