...
var (
	filter_QueryService_QueryCDPs_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_QueryService_QueryCDP_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"comdex", "cdp", "v1alpha1", "cdps", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_QueryCDPs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"comdex", "cdp", "v1alpha1", "cdps"}, "", runtime.AssumeColonVerbOpt(true)))
)
