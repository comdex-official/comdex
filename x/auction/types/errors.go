...
var (
	...
	ErrorInStartDutchAuction = sdkerrors.Register(ModuleName, 302, "error in start dutch auction for locked vault id")
	ErrorAssetRates          = sdkerrors.Register(ModuleName, 303, "error in asset rates")
)
