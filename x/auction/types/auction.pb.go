...
type DebtAuction struct {
	...
	AuctionMappingId    uint64                                        `protobuf:"varint,13,opt,name=auction_mapping_id,json=auctionMappingId,proto3" json:"auction_mapping_id,omitempty" yaml:"auction_mapping_id"`
	BidFactor           cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,14,opt,name=bid_factor,json=bidFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"bid_factor" yaml:"bid_factor"`
...
type DutchAuction struct {
	...
	OutflowTokenInitialPrice  cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,6,opt,name=outflow_token_initial_price,json=outflowTokenInitialPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"outflow_token_initial_price" yaml:"outflow_token_initial_price"`
	OutflowTokenCurrentPrice  cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,7,opt,name=outflow_token_current_price,json=outflowTokenCurrentPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"outflow_token_current_price" yaml:"outflow_token_current_price"`
	OutflowTokenEndPrice      cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,8,opt,name=outflow_token_end_price,json=outflowTokenEndPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"outflow_token_end_price" yaml:"outflow_token_end_price"`
	InflowTokenCurrentPrice   cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,9,opt,name=inflow_token_current_price,json=inflowTokenCurrentPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"inflow_token_current_price" yaml:"inflow_token_current_price"`
	...
	LiquidationPenalty        cosmossdk_io_math.LegacyDec                   `protobuf:"bytes,20,opt,name=liquidation_penalty,json=liquidationPenalty,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"liquidation_penalty" yaml:"liquidatin_penalty"`
}
...
type ProtocolStatistics struct {
	...
	Loss    cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=loss,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"loss" yaml:"loss"`
}
...
var fileDescriptor_4bb9aead25d5fe6c = []byte{
	...
	,
}
