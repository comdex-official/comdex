...
// source: petri/auction/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "petri.auction.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("petri/auction/v1beta1/genesis.proto", fileDescriptor_49088f171dd3086d)
}
