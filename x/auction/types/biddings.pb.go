...
// source: petri/auction/v1beta1/biddings.proto
...
func init() {
	proto.RegisterType((*SurplusBiddings)(nil), "petri.auction.v1beta1.SurplusBiddings")
	proto.RegisterType((*DebtBiddings)(nil), "petri.auction.v1beta1.DebtBiddings")
	proto.RegisterType((*DutchBiddings)(nil), "petri.auction.v1beta1.DutchBiddings")
}

func init() {
	proto.RegisterFile("petri/auction/v1beta1/biddings.proto", fileDescriptor_a5a3f4b8597bafd2)
}
