...
func GetQueryCmd() *cobra.Command {
	...
	cmd.AddCommand(
		...
		NewQueryOrdersCmd(),
		NewQueryOrderCmd(),
		NewQueryUserPoolsContributionCmd(),
		NewQueryAllUsersPoolsContributionCmd(),
	)
...
func NewQueryUserPoolsContributionCmd() *cobra.Command {
	cmd := &cobra.Command{
...
func NewQueryAllUsersPoolsContributionCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "userspoolsdata",
