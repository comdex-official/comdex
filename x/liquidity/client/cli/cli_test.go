...
import (
	...
	lapp "github.com/comdex-official/comdex/app"
	"github.com/comdex-official/comdex/x/liquidity"
	"github.com/comdex-official/comdex/x/liquidity/client/cli"
	liquiditytestutil "github.com/comdex-official/comdex/x/liquidity/client/testutil"
...
func (s *IntegrationTestSuite) TestExportGenesis() {
	...
	cmd := server.ExportCmd(
		func(_ tmlog.Logger, _ tmdb.DB, traceStore io.Writer, height int64, forZeroHeight bool, jailWhiteList []string,
			...
			if height != -1 {
				app = lapp.New(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), encCfg, appOpts)

				if err := app.LoadHeight(height); err != nil {
					return servertypes.ExportedApp{}, err
				}
			} else {
				app = lapp.New(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), encCfg, appOpts)
			}
