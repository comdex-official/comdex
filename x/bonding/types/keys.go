...
var (
	...
	// KeyPrefixPeriodLock defines prefix to store synthetic bonding by lock ID and synthetic suffix.
	KeyPrefixSyntheticBonding = []byte{0x0F}

	// KeyPrefixSyntheticLockTimestamp defines prefix for the iteration of synthetic bondings by timestamp.
