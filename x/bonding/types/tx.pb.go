...
// source: comdex/bonding/tx.proto
...
func init() {
	proto.RegisterType((*MsgLockTokens)(nil), "comdex.bonding.MsgLockTokens")
	proto.RegisterType((*MsgLockTokensResponse)(nil), "comdex.bonding.MsgLockTokensResponse")
	proto.RegisterType((*MsgBeginUnlockingAll)(nil), "comdex.bonding.MsgBeginUnlockingAll")
	proto.RegisterType((*MsgBeginUnlockingAllResponse)(nil), "comdex.bonding.MsgBeginUnlockingAllResponse")
	proto.RegisterType((*MsgBeginUnlocking)(nil), "comdex.bonding.MsgBeginUnlocking")
	proto.RegisterType((*MsgBeginUnlockingResponse)(nil), "comdex.bonding.MsgBeginUnlockingResponse")
}

func init() { proto.RegisterFile("comdex/bonding/tx.proto", fileDescriptor_bcdad5af0d24735f) }
...
func (c *msgClient) LockTokens(ctx context.Context, in *MsgLockTokens, opts ...grpc.CallOption) (*MsgLockTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/comdex.bonding.Msg/LockTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BeginUnlockingAll(ctx context.Context, in *MsgBeginUnlockingAll, opts ...grpc.CallOption) (*MsgBeginUnlockingAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/comdex.bonding.Msg/BeginUnlockingAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BeginUnlocking(ctx context.Context, in *MsgBeginUnlocking, opts ...grpc.CallOption) (*MsgBeginUnlockingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/comdex.bonding.Msg/BeginUnlocking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_LockTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comdex.bonding.Msg/LockTokens",
	}
...
func _Msg_BeginUnlockingAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comdex.bonding.Msg/BeginUnlockingAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BeginUnlocking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comdex.bonding.Msg/BeginUnlocking",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "comdex.bonding.Msg",
	...
	Metadata: "comdex/bonding/tx.proto",
}
