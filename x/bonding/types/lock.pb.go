...
// source: comdex/bonding/lock.proto
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=comdex.bonding.LockQueryType" json:"lock_query_type,omitempty"`
...
func init() {
	proto.RegisterEnum("comdex.bonding.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "comdex.bonding.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "comdex.bonding.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "comdex.bonding.SyntheticLock")
}

func init() { proto.RegisterFile("comdex/bonding/lock.proto", fileDescriptor_7e9d7527a237b489) }
...
var fileDescriptor_7e9d7527a237b489 = []byte{
	...
	,
}
