...
// source: comdex/bonding/v1beta1/lock.proto
...
const (
	...
	// Queries for bondings that started before a specific time
...
func (LockQueryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8b1c8d6949d1d7c7, []int{0}
}
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=comdex.bonding.v1beta1.LockQueryType" json:"lock_query_type,omitempty"`
	// What token denomination are we looking for bondings of
...
func (*QueryCondition) Descriptor() ([]byte, []int) {
	return fileDescriptor_8b1c8d6949d1d7c7, []int{1}
}
...
// SyntheticLock is a single unit of synthetic bonding
...
// allowing partial unlocks of synthetic bondings.
type SyntheticLock struct {
	// underlying native bonding id for this synthetic bonding
	...
	// used for unbonding synthetic bondings, for active synthetic bondings, this
...
func (*SyntheticLock) Descriptor() ([]byte, []int) {
	return fileDescriptor_8b1c8d6949d1d7c7, []int{2}
}
...
func init() {
	proto.RegisterEnum("comdex.bonding.v1beta1.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "comdex.bonding.v1beta1.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "comdex.bonding.v1beta1.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "comdex.bonding.v1beta1.SyntheticLock")
}

func init() { proto.RegisterFile("comdex/bonding/v1beta1/lock.proto", fileDescriptor_8b1c8d6949d1d7c7) }

var fileDescriptor_8b1c8d6949d1d7c7 = []byte{
	// 603 bytes of a gzipped FileDescriptorProto
	,
}
