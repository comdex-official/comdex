...
func queryModuleBalanceFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		res, height, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryModuleBalance), nil)
...
func queryModuleLockedAmountFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		res, height, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryModuleLockedAmount), []byte{})
...
func queryAccountUnlockableCoinsFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountUnlockableCoins), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountLockedCoinsFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountLockedCoins), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountLockedPastTimeFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountLockedPastTime), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountUnlockedBeforeTimeFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountUnlockedBeforeTime), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountLockedPastTimeDenomFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountLockedPastTimeDenom), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryLockedByIDFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryLockedByID), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountLockedLongerDurationFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountLockedLongerDuration), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
...
func queryAccountLockedLongerDurationDenomFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		res, _, err := clientCtx.QueryWithData(fmt.Sprintf("custom/bonding/%s", types.QueryAccountLockedLongerDurationDenom), bz)
		if rest.CheckInternalServerError(w, err) {
			return
		}
