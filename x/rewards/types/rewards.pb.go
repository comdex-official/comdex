...
type LendExternalRewards struct {
	...
	TotalRewards         github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,4,opt,name=total_rewards,json=totalRewards,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin" json:"total_rewards" yaml:"total_rewards"`
	RewardAssetId        uint64                                  `protobuf:"varint,5,opt,name=reward_asset_id,json=rewardAssetId,proto3" json:"reward_asset_id,omitempty" yaml:"epoch_id"`
...
func (m *LendExternalRewards) GetRewardAssetId() uint64 {
	if m != nil {
...
var fileDescriptor_d29f449503627a2b = []byte{
	...
	,
}
...
func (m *LendExternalRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RewardAssetId != 0 {
		i = encodeVarintRewards(dAtA, i, uint64(m.RewardAssetId))
		i--
		dAtA[i] = 0x28
	}
	{
...
func (m *LendExternalRewards) Size() (n int) {
	...
	n += 1 + l + sovRewards(uint64(l))
	if m.RewardAssetId != 0 {
		n += 1 + sovRewards(uint64(m.RewardAssetId))
	}
	if m.DurationDays != 0 {
		n += 1 + sovRewards(uint64(m.DurationDays))
	}
...
func (m *LendExternalRewards) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RewardAssetId", wireType)
			}
			m.RewardAssetId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RewardAssetId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
