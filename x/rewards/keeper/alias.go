...
func (k *Keeper) GetVault(ctx sdk.Context, id string) (vault vaultttypes.Vault, found bool) {
...
func (k *Keeper) UpdateAppExtendedPairVaultMappingDataOnMsgCreate(ctx sdk.Context, counter uint64, vaultData vaultttypes.Vault) {
