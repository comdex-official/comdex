...
var (
	...
	ErrorPriceDoesNotExist             = sdkerrors.Register(ModuleName, 207, "price does not exist")
	ErrorInvalidAmountIn               = sdkerrors.Register(ModuleName, 102, "invalid amount_in")
	ErrorInvalidAmountOut              = sdkerrors.Register(ModuleName, 103, "invalid amount_out")
	ErrorInvalidCollateralizationRatio = sdkerrors.Register(ModuleName, 205, "invalid collateralization ratio")
)
