...
type AssetRanking struct {
	AssetID uint64                                 `protobuf:"varint,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty" yaml:"asset_id"`
	Apr     github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=apr,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"apr" yaml:"apr"`
...
func (m *AssetRanking) Reset()         { *m = AssetRanking{} }
func (m *AssetRanking) String() string { return proto.CompactTextString(m) }
func (*AssetRanking) ProtoMessage()    {}
func (*AssetRanking) Descriptor() ([]byte, []int) {
	return fileDescriptor_b87bb4bef8334ddd, []int{24}
}
func (m *AssetRanking) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetRanking) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetRanking.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetRanking) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetRanking.Merge(m, src)
}
func (m *AssetRanking) XXX_Size() int {
	return m.Size()
}
func (m *AssetRanking) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetRanking.DiscardUnknown(m)
}

var xxx_messageInfo_AssetRanking proto.InternalMessageInfo

func (m *AssetRanking) GetAssetID() uint64 {
	if m != nil {
		return m.AssetID
	}
	return 0
...
type BorrowRanking struct {
	First  AssetRanking `protobuf:"bytes,1,opt,name=first,proto3" json:"first" yaml:"first"`
	Second AssetRanking `protobuf:"bytes,2,opt,name=second,proto3" json:"second" yaml:"second"`
	Third  AssetRanking `protobuf:"bytes,3,opt,name=third,proto3" json:"third" yaml:"third"`
}

func (m *BorrowRanking) Reset()         { *m = BorrowRanking{} }
func (m *BorrowRanking) String() string { return proto.CompactTextString(m) }
func (*BorrowRanking) ProtoMessage()    {}
func (*BorrowRanking) Descriptor() ([]byte, []int) {
	return fileDescriptor_b87bb4bef8334ddd, []int{25}
}
func (m *BorrowRanking) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BorrowRanking) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BorrowRanking.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BorrowRanking) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BorrowRanking.Merge(m, src)
}
func (m *BorrowRanking) XXX_Size() int {
	return m.Size()
}
func (m *BorrowRanking) XXX_DiscardUnknown() {
	xxx_messageInfo_BorrowRanking.DiscardUnknown(m)
}

var xxx_messageInfo_BorrowRanking proto.InternalMessageInfo

func (m *BorrowRanking) GetFirst() AssetRanking {
	if m != nil {
		return m.First
	}
	return AssetRanking{}
...
func (m *BorrowRanking) GetSecond() AssetRanking {
	if m != nil {
		return m.Second
	}
	return AssetRanking{}
...
func (m *BorrowRanking) GetThird() AssetRanking {
	if m != nil {
		return m.Third
	}
	return AssetRanking{}
...
type DepositRanking struct {
	First  AssetRanking `protobuf:"bytes,1,opt,name=first,proto3" json:"first" yaml:"first"`
	Second AssetRanking `protobuf:"bytes,2,opt,name=second,proto3" json:"second" yaml:"second"`
	Third  AssetRanking `protobuf:"bytes,3,opt,name=third,proto3" json:"third" yaml:"third"`
}

func (m *DepositRanking) Reset()         { *m = DepositRanking{} }
func (m *DepositRanking) String() string { return proto.CompactTextString(m) }
func (*DepositRanking) ProtoMessage()    {}
func (*DepositRanking) Descriptor() ([]byte, []int) {
	return fileDescriptor_b87bb4bef8334ddd, []int{26}
}
func (m *DepositRanking) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DepositRanking) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DepositRanking.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DepositRanking) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DepositRanking.Merge(m, src)
}
func (m *DepositRanking) XXX_Size() int {
	return m.Size()
}
func (m *DepositRanking) XXX_DiscardUnknown() {
	xxx_messageInfo_DepositRanking.DiscardUnknown(m)
}

var xxx_messageInfo_DepositRanking proto.InternalMessageInfo

func (m *DepositRanking) GetFirst() AssetRanking {
	if m != nil {
		return m.First
	}
	return AssetRanking{}
...
func (m *DepositRanking) GetSecond() AssetRanking {
	if m != nil {
		return m.Second
	}
	return AssetRanking{}
...
func (m *DepositRanking) GetThird() AssetRanking {
	if m != nil {
		return m.Third
	}
	return AssetRanking{}
...
func init() {
	...
	proto.RegisterType((*AssetRanking)(nil), "comdex.lend.v1beta1.Asset_ranking")
	proto.RegisterType((*BorrowRanking)(nil), "comdex.lend.v1beta1.Borrow_ranking")
	proto.RegisterType((*DepositRanking)(nil), "comdex.lend.v1beta1.Deposit_ranking")
}
...
var fileDescriptor_b87bb4bef8334ddd = []byte{
	...
	,
}
...
func (m *AssetRanking) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetRanking) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetRanking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BorrowRanking) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BorrowRanking) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BorrowRanking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.Third.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x1a
	{
		size, err := m.Second.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DepositRanking) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DepositRanking) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DepositRanking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AssetRanking) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BorrowRanking) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DepositRanking) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AssetRanking) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Asset_ranking: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Asset_ranking: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BorrowRanking) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Borrow_ranking: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Borrow_ranking: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			if err := m.Third.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DepositRanking) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Deposit_ranking: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Deposit_ranking: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
