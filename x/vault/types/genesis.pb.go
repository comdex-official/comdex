...
// source: petri/vault/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "petri.vault.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("petri/vault/v1beta1/genesis.proto", fileDescriptor_00ed468466e13f8a)
}
