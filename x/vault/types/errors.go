...
var (
	...
	ErrorInvalidExtendedPairMappingData  = errors.Register(ModuleName, 216, "Invalid Extended Pair Vault Mapping data sent as compared to data exists in vault")
	ErrorVaultInactive                   = errors.Register(ModuleName, 217, "Vault tx Inactive")
)
