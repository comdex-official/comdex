...
func (k msgServer) MsgVaultCalculateInterest(c context.Context, msg *types.MsgVaultInterestCalcRequest) (*types.MsgVaultInterestCalcRequest, error) {
	...
	return &types.MsgVaultInterestCalcRequest{}, nil
}
