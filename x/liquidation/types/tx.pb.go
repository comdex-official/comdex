...
func init() {
	...
	proto.RegisterType((*MsgLiquidateBorrowRequest)(nil), "petri.liquidation.v1beta1.MsgLiquidateBorrowRequest")
	proto.RegisterType((*MsgLiquidateBorrowResponse)(nil), "petri.liquidation.v1beta1.MsgLiquidateBorrowResponse")
}
...
func (c *msgClient) MsgLiquidateBorrow(ctx context.Context, in *MsgLiquidateBorrowRequest, opts ...grpc.CallOption) (*MsgLiquidateBorrowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.liquidation.v1beta1.Msg/MsgLiquidateBorrow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_MsgLiquidateBorrow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.liquidation.v1beta1.Msg/MsgLiquidateBorrow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
