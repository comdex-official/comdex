...
func init() {
	proto.RegisterType((*LiquidationOffsetHolder)(nil), "comdex.liquidation.v1beta1.LiquidationOffsetHolder")
}

func init() {
	proto.RegisterFile("comdex/liquidation/v1beta1/liquidations.proto", fileDescriptor_3205485f72b5dae7)
}
