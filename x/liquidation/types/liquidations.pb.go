...
// source: petri/liquidation/v1beta1/liquidations.proto
...
func init() {
	proto.RegisterType((*LiquidationOffsetHolder)(nil), "petri.liquidation.v1beta1.LiquidationOffsetHolder")
}

func init() {
	proto.RegisterFile("petri/liquidation/v1beta1/liquidations.proto", fileDescriptor_3205485f72b5dae7)
}
