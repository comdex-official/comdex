...
// source: petri/asset/v1beta1/events.proto
...
func init() {
	proto.RegisterType((*EventAddPair)(nil), "petri.asset.v1beta1.EventAddPair")
}

func init() { proto.RegisterFile("petri/asset/v1beta1/events.proto", fileDescriptor_8698e7aadaab4005) }
