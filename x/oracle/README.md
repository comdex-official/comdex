...
See [oracle tx proto](https://github.com/comdex-official/comdex/blob/main/proto/ojo/oracle/v1/tx.proto#L11) for list of supported messages.

## Events

See [oracle events proto](https://github.com/comdex-official/comdex/blob/main/proto/ojo/oracle/v1/events.proto) for list of supported events.

## Params

See [oracle events proto](https://github.com/comdex-official/comdex/blob/main/proto/ojo/oracle/v1/oracle.proto#L11) for list of module parameters.
