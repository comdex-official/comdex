...
const (
	CmdxDenom       string = appparams.BondDenom
	CmdxSymbol      string = "cmdx"
	CmdxExponent           = uint32(6)
	AtomDenom       string = "ibc/961FA3E54F5DCCA639F37A7C45F7BBE41815579EF1513B5AFBEFCFEB8F256352"
